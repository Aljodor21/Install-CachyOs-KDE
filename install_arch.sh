...
log_info "  Para que tome efecto, cerrá sesión KDE y volvé a entrar:"
log_info "    - grupo docker (docker sin sudo)"
log_info "    - grupo libvirt (virt-manager sin sudo)"
log_info "    - zsh como shell por defecto"
log_info "    - apps pineadas a taskbar (Plasma 6 necesita re-login, no restart)"
log_info ""
log_info "  Logout:  qdbus org.kde.KWin /Session logout 0 0 0 0 0"
log_info "          (o: loginctl terminate-user $USER)"
log_info ""
